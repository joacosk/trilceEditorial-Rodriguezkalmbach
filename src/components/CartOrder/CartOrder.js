...
import db, { createBuyOrder } from "../../services/firestore"
import "./CartOrder.css"
import swal from 'sweetalert';

function OrderConfirm(props) {

    const {getTotalPrice,clearCart,getOrdenCompleta,ordenCompleta} = useContext(CartContext)
    ...
    const submitHandler = async (event) =>{
        ...
        await createBuyOrder(order).then((doc)=>{ swal({
